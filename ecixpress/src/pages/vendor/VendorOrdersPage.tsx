...
import { MessageCircle, Store as StoreIcon, User, ChevronRight, ChevronLeft, XCircle, Loader2, Search, X } from 'lucide-react';
...
const VendorOrdersPage: React.FC<VendorOrdersPageProps> = () => {
