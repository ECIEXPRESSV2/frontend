...
export const ORDER_STATUS_CONFIG: Record<OrderStatus, StatusMeta> = {
  ...
  preparing: { icon: ChefHat,      label: 'Listo para retirar', pillClass: 'bg-amber-100 text-amber-800 border-amber-200',   accentClass: 'bg-amber-400' },
  ready:     { icon: PackageCheck, label: 'Listo para retirar', pillClass: 'bg-cyan-50 text-cyan-800 border-cyan-200',      accentClass: 'bg-cyan-400' },
