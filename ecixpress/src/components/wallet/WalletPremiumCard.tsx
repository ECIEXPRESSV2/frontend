...
const WalletPremiumCard: React.FC<WalletPremiumCardProps> = ({ className = '' }) => {
  ...
  return (
    <div
      className={`relative aspect-[16/10] w-full max-w-md overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#E9B44A_0%,#F5C94A_42%,#F7E2AA_100%)] p-6 text-white shadow-[0_18px_40px_-12px_rgba(245,158,11,0.42)] ring-1 ring-white/30 ${className}`}
      role="group"
      ...
      <div className="relative flex h-full flex-col justify-between">
        ...
        <div className="flex items-end justify-between text-sm">
          <div className="space-y-1">
            ...
            <span className="block font-semibold tracking-wide text-white">Billetera digital</span>
          </div>
